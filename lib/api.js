...
export async function getBook(key) {
	// this has to be /works/OL123M to work
	// title, year, author, ratings, description, cover
	try {
...
// export async function getReleaseYear(workKey) {
// 	try {
// 		const editionsResponse = await axios.get(
// 			`${base_url}${workKey}/editions.json`
// 		);
...
// 		const allEditions = editionsResponse.data.entries;
...
// 			)
// 			.sort((a, b) => {
// 				const yearA = extractYear(a.publish_date) || 0;
// 				const yearB = extractYear(b.publish_date) || 0;
// 				return yearA - yearB;
// 			});
// 		// console.log(sortedEditions[0]);
// 		// console.log(extractYear(sortedEditions[0].publish_date));

// 		return sortedEditions.length > 0
// 			? extractYear(sortedEditions[0].publish_date)
// 			: "NA";
// 	} catch (error) {
// 		throw error;
// 	}
